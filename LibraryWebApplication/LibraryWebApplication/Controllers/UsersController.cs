...
namespace LibraryWebApplication.Controllers
{
    public class UsersController : Controller
    {
        ...
        public IActionResult Create([Bind("user_id,library_id,name,email,password")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Edit(int id, [Bind("user_id,library_id,name,email,password")] User user)
        {
            if (id != user.user_id)
            {
                return NotFound();
